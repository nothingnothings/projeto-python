...
class Blockchain:
    ...
    @property    ####necessário --> uso de PROPERTIES... ->  sintaxe obrigatória de GETTERS...
...
# load_data() ###agora será chamado de DENTRO DO CONSTRUCTOR DE 'Blockchain'....
    ...
    def mine_block(self):
        ...
        block = Block(hashed_block, len(self._chain), copied_transactions, proof)
        # blockchain.append(block)
        self._chain.append(block)
        # self.open_transactions = []
        # self.__open_transactions = copied_transactions
        self.__open_transactions = []
        # self.save_data()
