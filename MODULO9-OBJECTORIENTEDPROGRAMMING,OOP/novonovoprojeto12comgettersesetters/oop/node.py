...
from blockchain13comgettersesetters import Blockchain
            ...
            if(user_input == '1'):
                ...
                # if mine_block():
                  if self.blockchain.mine_block():
                    ...
                    FileAccess.save_data(self.blockchain.chain, self.blockchain.get_open_transactions())
                    # self.blockchain.__open_transactions = []
                    # save_data()
            elif(user_input == '3'):
